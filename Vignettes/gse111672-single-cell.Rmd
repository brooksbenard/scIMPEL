...
base_colors <- c("#4477AA", "#EE6677", "#228833", "#CCBB44", "#66CCEE", "#AA3377",
  "#BBBBBB", "#EE8866", "#FFAABB", "#99DDFF", "#DDDDDD", "#77AADD")
shared_pal_lineage <- setNames(
  if (length(all_celltypes) <= 12) base_colors[seq_len(length(all_celltypes))] else colorRampPalette(base_colors)(length(all_celltypes)),
  all_celltypes
)
...
group_col2 <- grep("prognostic_group_weighted_sum_score", names(seurat2@meta.data), value = TRUE)[1]
markers2 <- NULL
if (!is.na(group_col2)) {
...
heatmap_colors2 <- if (requireNamespace("viridis", quietly = TRUE)) {
  viridis::viridis(100)
} else {
  colorRampPalette(c("#2166AC", "#F7F7F7", "#B2182B"))(100)
}
