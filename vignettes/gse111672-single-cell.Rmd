...
if (!file.exists(rds_path) && requireNamespace("googledrive", quietly = TRUE)) {
  ...
  googledrive::drive_download(as_id("1vJxIlW_kvqFXOPw9qn1L7D6QbMpe-P0c"), rds_path, overwrite = TRUE)
}
...
if (!has_data) {
  ...
  if (!file.exists(rds_path2) && requireNamespace("googledrive", quietly = TRUE)) {
    googledrive::drive_deauth()
    googledrive::drive_download(as_id("14p_fYIFeuuRdXBF3J-5ZsXElq_mduSzb"), rds_path2, overwrite = TRUE)
  }
