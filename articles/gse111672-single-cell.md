...
```
    ...
    ## [Marker analysis GSE111672] Runtime: 0.97 s | Memory: -
...
```
    ...
    ## [Heatmap GSE111672] Runtime: 2.05 s | Memory: -
...
```
    ...
    ## [Proportion plot GSE111672] Runtime: 3.03 s | Memory: -
...
```
    ...
    ## [Score CRA001160] Runtime: 0.66 s | Memory: 349.2 Mb
...
![](gse111672-single-cell_files/figure-html/score-by-celltype-cra001160-1.png)
    ...
    ## [Cell type plot CRA001160] Runtime: 0.38 s | Memory: -
...
```
    ...
    ## [Marker analysis CRA001160] Runtime: 2.21 s | Memory: -
...
![](gse111672-single-cell_files/figure-html/heatmap-markers-cra001160-1.png)
    ...
    ## [Heatmap CRA001160] Runtime: 6.66 s | Memory: -
